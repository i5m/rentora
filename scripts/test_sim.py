...
house = HouseInput(total_cost=400000, mortgage_interest_rate=6.5, mortgage_years=30, monthly_utilities=250, appreciation_yoy=3.0, closing_cost=8000, down_payment_percentage=20, annual_insurance=1200, property_tax_percentage=1.2, pmi=0.5)
...
res = run_simulation(loc, rent, house, investments, heloc, 30)
